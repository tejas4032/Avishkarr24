    ...
    <table class="styled-table" id= "table_id">
      ...
      <tbody id="tbody_table_record">
        <?php
          ...
          $num = 0;
          //------------------------------------------------------------ The process for displaying a record table containing the sensor data and the state of the LEDs.
          ...
          foreach ($pdo->query($sql) as $row) {
            ...
            echo '<td class="bdr">'. $row['air_quality'] . '</td>';
            echo '<td class="bdr">'. $row['status_read_mq135'] . '</td>';
