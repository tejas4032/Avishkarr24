...
<html>
  ...
  <body>
    ...
    <div class="content">
      <div class="cards">
        ...
        <div class="card">
          ...
          <h4 class="airQualityColor"><i class="fas fa-wind"></i> AIR QUALITY</h4>
          <p class="airQualityColor"><span class="reading"><span id="ESP32_01_AirQuality"></span> PPM</span></p>
          <!-- *********************************************************************** -->
    ...
    <script>
      ...
      document.getElementById("ESP32_01_AirQuality").innerHTML = "NN";
        ...
        xmlhttp.onreadystatechange = function() {
          if (this.readyState == 4 && this.status == 200) {
            ...
            if (myObj.id == "esp32_01") {
              ...
              document.getElementById("ESP32_01_AirQuality").innerHTML = myObj.air_quality;
